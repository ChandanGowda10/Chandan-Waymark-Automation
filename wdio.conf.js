...
exports.config = {
  ...
  // chmod 777 e2e-tests.sh for permission denied error
  suites: {
    scenario1: [
       "./e2eTests/specs/SmokeSuite.spec.js"
    ]
  },
  // Patterns to exclude.
  exclude: [
  ...
  capabilities: [
    {
      ...
      proxy: {
        proxyType: "manual",
        httpsProxy: "corporate.proxy:10800",
  ...
  // testRailsOptions: {
  //   domain: "https://2497inc.testrail.io",
  //   username: "mahantesh@calibrecode.com",
  //   password: "Calibre@2017",
  //   projectId: 1,
  //   suiteId: 4,
  //   runName: "BackendPortal-SmokeTest1"
  // },
  ...
  reporterOptions: {
    ...
    // slack : {
    //   notify: true,
    //   webhook: "https://hooks.slack.com/services/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",
    //   notifyOnlyOnFailure: false,
    //   username: 'automation-results-bot',
    //   message: "New e2e Results",
    //   // results: "testurl"
    // },
